...
from pratice_demo.pratice_xueqiu_search_PO_wrapper.page.wrapper_class import WrapperBlack
from pratice_demo.pratice_xueqiu_search_PO_wrapper.page.wrapper_decorated import logit
